...
namespace SpaceViewer.Objects
{
	...
	public struct mat4
    {
        ...
        public mat4(mat4 copyFrom)
        {
            cols = new[]
                       {
                           new vec4(copyFrom.cols[0][0], copyFrom.cols[0][1], copyFrom.cols[0][2], copyFrom.cols[0][3]),
                           new vec4(copyFrom.cols[1][0], copyFrom.cols[1][1], copyFrom.cols[1][2], copyFrom.cols[1][3]),
                           new vec4(copyFrom.cols[2][0], copyFrom.cols[2][1], copyFrom.cols[2][2], copyFrom.cols[2][3]),
                           new vec4(copyFrom.cols[3][0], copyFrom.cols[3][1], copyFrom.cols[3][2], copyFrom.cols[3][3])
                       };
        }
